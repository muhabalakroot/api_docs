import{_ as r,m as o,r as s,o as c,c as h,w as n,a as l,V as u,b as p,d as t,t as d}from"./index-a977af96.js";import{T as g,u as m}from"./TheEnviromentSelecter-f0ed81b1.js";import{V as _,a as e}from"./VCard-06dac4c7.js";import{V as b}from"./VTable-b3a8d084.js";const f={components:{TheEnviromentSelecter:g},computed:{...o(m,["activeEnviroment"])},methods:{redirect(){this.$router.push({name:"GetPackage"})}}},y=t("div",{class:"mb-2 text-h3",align:"center"},"Packages",-1),k=t("div",{class:"ma-2 text-h4"},"Get Returned Packages",-1),T=t("div",{class:"text-subtitle-1 font-weight-black mt-3"}," Brief description: ",-1),v=t("ul",{class:"ml-5"},[t("li",null,' The "Get Returned Packages" endpoint is a read-only API that allows you to retrieve a list of packages that have been returned to the courier service. Returned packages are shipments that were not successfully delivered to the intended recipient or location and have been sent back to the courier. ')],-1),S=t("div",{class:"text-subtitle-1 font-weight-black mt-3"},"Request URL:",-1),N={class:"ml-5"},x=t("div",{class:"text-subtitle-1 font-weight-black mt-3"},"Method:",-1),w=t("ul",{class:"ml-5"},[t("li",null,"GET")],-1),A=t("div",{class:"text-subtitle-1 font-weight-black mt-3"},"Request example:",-1),C={class:"ml-5"},E=t("div",{class:"text-subtitle-1 font-weight-black mt-3"},"Return example:",-1),I=t("code",null,[t("pre",{class:"overflow-x-auto"},`{  
    "status_code": 200,
