<template>
  <v-card class="ma-4 pa-6">
    ...
    <div>
      <div class="ma-2 text-h4">Get All SubCities</div>
      ...
      <ul class="ml-5">
        <li>
          It allows users to get all of the SubCities of a City with there IDs.
          (note that some Cities does not have SubCities)
        </li>
      </ul>
